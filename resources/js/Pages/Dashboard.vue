    ...
    <div class="ava-page ava-page--chat">
                    ...
                    <div class="chat-block__controls">
                        <div class="chat-block__controls-field">
                            <form @submit="sendMessage">
                                <input id="user-input" v-model="userMessage" autocomplete="off"
                                    class="chat-block__controls-input" type="text" name="textField" value=""
        ...
        <div class="popup-wrapper">
            <div class="popup-block popup-block--1">
                ...
                <p class="mb-8">You are a medical representative. Your aim is to obtain a doctor’s permission for a visit
                    but the doctor looks tired and a little grumpy. Her answers have a negative tone. You can see that she
                    is not in the mood to communicate with you today, but it is important for you to have  the visit today.
                </p>
                <p class="mb-8">The doctor is medium-loyal but high-potential for your company. You've already met several
                    times, but today, unfortunately, she is "in a bad mood" — there's a line of patients and she has no
                    desire to talk to you. Try to persuade her to listen to you.</p>
                <p class="mr-auto">So, you come into doctor’s office...</p>
                <button class="btn-ava mx-auto mt-40 popup-close" @click="makeConnection"><span>Enter Ava’s
                        Office</span></button>
            </div>
...
async function processTalk(msg) {
    if (
        ...
        const responseFromOpenAI = await fetchOpenAIResponse(chatMessages);
